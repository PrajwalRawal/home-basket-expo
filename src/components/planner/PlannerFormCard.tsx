...
const categories: Array<GroceryCategory> = [
  "Produce",
  "Dairy",
  "Bakery",
  "Pantry",
...
const priorities: Array<GroceryPriority> = ["low", "medium", "high"];
...
const PlannerFormCard = () => {
  ...
  const createItem = async () => {
    ...
    Alert.alert("Success", "New Grocery Item added");
      ...
      <View className="mt-2 flex-row flex-wrap gap-2">
        {categories.map((option) => {
          ...
          return (
            ...
            >
              <FontAwesome6
                name={categoryIcons[option] as any}
                size={12}
                iconStyle="solid"
